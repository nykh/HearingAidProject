...
// uart interrupt
#define UART_IER_ERBI       0x01    // Receiver data available and character timeout indication
#define UART_IER_ETBEI      0x02    // Transmitter holding register empty
#define UART_IER_ELSI       0x04    // Receiver line status
#define UART_IER_EDSSI      0x08    // Modem Status
